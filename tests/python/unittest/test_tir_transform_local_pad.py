...
class MatMulNNOriginalModule:
    ...
    @T.prim_func
    def main(
        A: T.Buffer[(960, 770), "float32"],
        B: T.Buffer[(770, 2304), "float32"],
        C: T.Buffer[(960, 2304), "float32"],
    ) -> None:
                ...
                for i_2_j_2_fused in T.thread_binding(256, thread="threadIdx.x"):
                                ...
                                for ax0_ax1_fused_2 in T.vectorized(3):
                                    with T.block("A_shared"):
                                        ...
                                        T.where(
                                            ...
                                            % 4
                                            < 770
                                            and (ax0_ax1_fused_0 * 256 + ax0_ax1_fused_1) * 3
                                            + ax0_ax1_fused_2
                                            < 512
                                        )
                                        T.reads(A[v0, v1])
                                ...
                                for ax0_ax1_fused_2 in T.vectorized(4):
                                    with T.block("B_shared"):
                                        ...
                                        T.where(
                                            k_0 * 4
                                            + (
                                                (ax0_ax1_fused_0 * 256 + ax0_ax1_fused_1) * 4
                                                + ax0_ax1_fused_2
                                            )
                                            // 128
                                            < 770
                                            and (ax0_ax1_fused_0 * 256 + ax0_ax1_fused_1) * 4
                                            + ax0_ax1_fused_2
                                            < 512
                                        )
                                        T.reads(B[v0, v1])
                    ...
                    for ax0, ax1 in T.grid(16, 2):
                        with T.block("C_local"):
                            v0 = T.axis.spatial(
                                960, i_0_j_0_fused // 18 * 128 + i_2_j_2_fused // 32 * 16 + ax0
                            )
                            v1 = T.axis.spatial(
                                2304,
                                i_0_j_0_fused % 18 * 128
                            ...
                            T.where(
                                i_0_j_0_fused // 18 * 128 + i_2_j_2_fused // 32 * 16 + ax0 < 960
                            )
